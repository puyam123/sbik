...
/* Basemap Layers */
var woodcutOSM = L.tileLayer("//{s}.tiles.mapbox.com/v3/eleanor.mnyzxgvi/{z}/{x}/{y}.png", {
  maxZoom: 21,
  subdomains: ["a", "b", "c", "d"],
...
var mapboxTer = L.tileLayer("//api.tiles.mapbox.com/v4/dmofot.n9pd56jd/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZG1vZm90IiwiYSI6IjMyODFmMjkwYTQ1NjUxYTEzOWYwOGZlMTMxY2FjZThiIn0.eNpL_ksyAN2Tcy5UeLqhyQ", {
  maxZoom: 21,
  attribution: 'Tiles <a href="http://www.mapbox.com" target="_blank">Mapbox</a>| Map data (c) <a href="http://www.openstreetmap.org/" target="_blank">OpenStreetMap</a>'
});
